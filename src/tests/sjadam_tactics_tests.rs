...
fn sjadammate1() {
    ...
    let correct_move = board.move_from_san("d5g7").unwrap();
...
fn sjadammate2() {
    ...
    let correct_move = board.move_from_san("c4b4").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate3() {
    ...
    let correct_move = board.move_from_san("d6f5").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate6() {
    ...
    let correct_move = board.move_from_san("b8d8").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate7() {
    ...
    let correct_move = board.move_from_san("f4c3").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate8() {
    ...
    let correct_move = board.move_from_san("g6g5").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate9() {
    ...
    let correct_move = board.move_from_san("c8e7").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate10() {
    ...
    let correct_move = board.move_from_san("d3f6").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate11() {
    ...
    let correct_move = board.move_from_san("d7f5").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate12() {
    ...
    let correct_move = board.move_from_san("d1g4").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate13() {
    ...
    let correct_move = board.move_from_san("d7d5").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate14() {
    ...
    let correct_move = board.move_from_san("f3c6").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate15() {
    ...
    let correct_move = board.move_from_san("d4f7").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate16() {
    ...
    let correct_move = board.move_from_san("g6b1").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate17() {
    ...
    let correct_move = board.move_from_san("e4e5").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate18() {
    ...
    let correct_move = board.move_from_san("d7g6").unwrap();
    is_mate_in_one(&board, correct_move);
}
