...
fn sjadammate1() {
    ...
    let correct_move = SjadamMove::from_alg("d5g7").unwrap();
...
fn sjadammate6() {
    ...
    let correct_move = SjadamMove::from_alg("b8d8").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate7() {
    ...
    let correct_move = SjadamMove::from_alg("f4c3").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate9() {
    ...
    let correct_move = SjadamMove::from_alg("c8e7").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate10() {
    ...
    let correct_move = SjadamMove::from_alg("d3f6").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate12() {
    ...
    let correct_move = SjadamMove::from_alg("d1g4").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate15() {
    ...
    let correct_move = SjadamMove::from_alg("d4f7").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate16() {
    ...
    let correct_move = SjadamMove::from_alg("g6b1").unwrap();
    is_mate_in_one(&board, correct_move);
}
...
fn sjadammate18() {
    ...
    let correct_move = SjadamMove::from_alg("d7g6").unwrap();
    is_mate_in_one(&board, correct_move);
}
